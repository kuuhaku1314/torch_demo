"""GoogLeNet通过不同窗口形状的卷积层和最大汇聚层来并行抽取信息"""
import torch
...
class Inception(nn.Module):
    ...
    def __init__(self, in_channels, c1, c2, c3, c4, **kwargs):
        ...
        self.p2_2 = nn.Conv2d(c2[0], c2[1], kernel_size=(3, 3), padding=1)
        # 线路3，1x1卷积层后接5x5卷积层
...
def train():
    ...
    b2 = nn.Sequential(nn.Conv2d(64, 64, kernel_size=(1, 1)),
                       nn.ReLU(),
    ...
    d2l.print_net(net, torch.rand(size=(1, 1, 96, 96)))
